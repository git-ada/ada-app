...
@Controller
@Module(name="渠道链接")
@RequestMapping(value = "/ada-channel-link")
public class AdaChannelLinkManagerController extends AbstractJQueryEntityController<AdaChannelLink, AdaChannelLinkService> {
	/**
	 * 权限列表
	 */
	...
	@Autowired
	private AdaChannelLinkService adaChannelLinkService;
	...
	@ResponseBody
	public JsonEntityResult<AdaChannelLink> get(HttpServletRequest request,HttpServletResponse response, Model model) {
	...
	@ResponseBody
	public JsonEntityResult<AdaChannelLink> save(HttpServletRequest request,HttpServletResponse response) {
	...
	@ResponseBody
	public JsonEntityResult<AdaChannelLink> update(HttpServletRequest request,HttpServletResponse response) {
	...
	protected String[] getExportTitles() {
		return new String[]{"链接ID","渠道ID","网页链接地址","参数","创建时间",""};
	}
}

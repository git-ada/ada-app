...
@Controller
@Module(name="渠道")
@RequestMapping(value = "/ada-channel")
public class AdaChannelManagerController extends AbstractJQueryEntityController<AdaChannel, AdaChannelService> {
	/**
	 * 权限列表
	 */
	...
	@Autowired
	private AdaChannelService adaChannelService;
	...
	@ResponseBody
	public JsonEntityResult<AdaChannel> get(HttpServletRequest request,HttpServletResponse response, Model model) {
	...
	@ResponseBody
	public JsonEntityResult<AdaChannel> save(HttpServletRequest request,HttpServletResponse response) {
	...
	@ResponseBody
	public JsonEntityResult<AdaChannel> update(HttpServletRequest request,HttpServletResponse response) {
	...
	protected String[] getExportTitles() {
		return new String[]{"渠道ID","站点ID","渠道名称","创建时间",""};
	}
}

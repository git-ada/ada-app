...
@Controller
@Module(name="广告页")
@RequestMapping(value = "/ada-ad-page")
public class AdaAdPageManagerController extends AbstractJQueryEntityController<AdaAdPage, AdaAdPageService> {
	/**
	 * 权限列表
	 */
	...
	@Autowired
	private AdaAdPageService adaAdPageService;
	...
	@ResponseBody
	public JsonEntityResult<AdaAdPage> get(HttpServletRequest request,HttpServletResponse response, Model model) {
	...
	@ResponseBody
	public JsonEntityResult<AdaAdPage> save(HttpServletRequest request,HttpServletResponse response) {
	...
	@ResponseBody
	public JsonEntityResult<AdaAdPage> update(HttpServletRequest request,HttpServletResponse response) {
	...
	protected String[] getExportTitles() {
		return new String[]{"渠道ID","站点ID","渠道名称","创建时间","createTime",""};
	}
}

...
public class AdaAccessLogManagerController extends AbstractJQueryEntityController<AdaAccessLog, AdaAccessLogService> {
	...
	@Autowired
	private AdaAccessLogService adaAccessLogService;
	...
	@ResponseBody
	public JsonEntityResult<AdaAccessLog> get(HttpServletRequest request,HttpServletResponse response, Model model) {
	...
	@ResponseBody
	public JsonEntityResult<AdaAccessLog> save(HttpServletRequest request,HttpServletResponse response) {
	...
	@ResponseBody
	public JsonEntityResult<AdaAccessLog> update(HttpServletRequest request,HttpServletResponse response) {

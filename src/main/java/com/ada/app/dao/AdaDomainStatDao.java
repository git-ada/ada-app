...
public interface AdaDomainStatDao extends EntityJpaDao<AdaDomainStat, Integer> {
    ...
    @Query(value="select ip from ada_domain_stat where siteId=? and domainId = ? and date = ?",nativeQuery=true)
    public Integer findByDateLoadIp(Integer siteId,Integer domainId,Date date);

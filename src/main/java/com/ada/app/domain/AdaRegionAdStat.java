 ...
 */
@Entity
@Table(name = "ada_region_ad_stat")
public class AdaRegionAdStat extends AbstractEntity<Integer> implements BaseStat{
    /** ID */
	private Integer id;                    
    /** 站点ID */
...
//	}
	...
	public AdaRegionAdStat(Integer ip, Integer pv, Integer clickip1,

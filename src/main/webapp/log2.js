/** 日志服务器地址 **/
var logserver = "http://192.250.196.186:8002";
var adaPageInTime = 0;
var adaSiteId;
var adaClientId;
var adaChannelId="";
...
function adaPutLog() {
	...
	httprequest.open("get", logserver + "/l?u="+adaClientId+"&s="+adaSiteId+"&c="+adaChannelId+"&n="+adaMouseClickTimes+"&t="+t+"&p="+p+"&t1="+Date.parse(new Date()), true);
	httprequest.onreadystatechange = function () {
		if (httprequest.readyState == 4) {
			if (httprequest.status == 200) {

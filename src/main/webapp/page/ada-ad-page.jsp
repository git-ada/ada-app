...
<div class="portlet light">
	...
	<div class="portlet-title">
		...
		<div class="row">
		    ...
		    <div class="caption">
				<div class="clearfix ">
				    <form id="search_from" class="form-horizontal" action="${pageContext.request.contextPath}/ada-ad-page/list.jhtm" method="get">
		    ...
		    <div class="col-md-2 col-sm-12 right">
	            <a class="buttons-excel buttons-html5 btn purple btn-outline opt-export" data-opt-key="/ada-ad-page/export"><span>导出表格</span></a>
	    ...
	    <div class="row">
	        ...
	        <c:if test="${not empty page.pageResults}">
	        	<div class="col-md-4 col-sm-12">
		            ...
		            <button class="btn btn-sm disabled opt-depend-select opt-batch-delete" data-opt-key="/ada-ad-page/delete">删除 </button>
		        </div>
			    <div class="row">
			        <!-- 底部分页 -->
			        <div class="col-md-4 col-sm-12">
...
<script type="text/javascript">
	...
	$(".opt-export").click(function() { 
		//refreshPage();
		var exportUrl = "${pageContext.request.contextPath}/ada-ad-page/export.do?"+$("#search_from").find("[value!='']").serialize();
    ...
    $(".opt-batch-delete").confirmation({
     ...
     var deleteItems = function(ids){
    	 jQuery.ajax({
      		url:"${pageContext.request.contextPath}/ada-ad-page/delete.do?id="+ids,
        ...
        <div class="tab-pane page-quick-sidebar-settings">
            <div class="page-quick-sidebar-settings-list">
                ...
                <div class="list-items">
					<form id="edit_form" action="${pageContext.request.contextPath}/ada-ad-page/update.do" class="form-horizontal" method="post">
...
<script type="text/javascript">
    ...
    $('.opt-edit').click(function(){
    	 var id = $(this).attr("data-id");
    		 $.ajax({  
                 url : "${pageContext.request.contextPath}/ada-ad-page/get.do",
                 data : {"id" : id},
                 success : function(ret) {
                 		$("#edit_form").find("[name='id']").val(ret.entity.id);
                 		$("#edit_form").find("[name='siteId']").val(ret.entity.siteId);
                 		$("#edit_form").find("[name='matchContent']").val(ret.entity.matchContent);
                 		$("#edit_form").find("[name='channelKey']").val(ret.entity.channelKey);
    ...
    $(".opt-edit-delete").confirmation({
        ...
        onConfirm: function(){
        	...
        	jQuery.ajax({
          		url:"${pageContext.request.contextPath}/ada-ad-page/delete.do?id="+id,
          		success:function(ret){
          			if(ret.success){
          				$("body").toggleClass("page-quick-sidebar-open");
	           			toastr.success(ret.message);

...
<div class="page-bar">
    <ul class="page-breadcrumb" style="width: 100%">
        ...
        <li>
            <a href="javascript:;" onclick="gotoPage('${pageContext.request.contextPath}/ada-channel-link/list.jhtm')"> 渠道链接 </a>
            <i class="fa fa-angle-right"></i>
        </li>
        <li>
            <span>新增</span>
...
<div class="portlet light ">
    <div class="portlet-body form">
        <form id="edit_form" action="${pageContext.request.contextPath}/ada-channel-link/${action=='create'?'save':'update'}.do" class="form-horizontal" method="post">
        <jodd:form bean="adaChannelLink" scope="request">

	...
	jQuery(document).ready(function() {
	    ...
	    jQuery("#fullscreenOractual").click(function(){
	    	 if(jQuery("#fullscreenOractual i").attr("class")=="icon-size-fullscreen"){
	    		 ...
	    		 jQuery(".DTFC_LeftBodyWrapper").css("height",document.documentElement.clientHeight-123);
	    		 jQuery(".DTFC_LeftBodyLiner").css("height",document.documentElement.clientHeight-123);

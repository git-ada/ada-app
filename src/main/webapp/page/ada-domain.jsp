...
<div class="portlet light">
	<div class="portlet-title">
		...
		<div class="row">
		    ...
		    <div class="caption">
				<div class="clearfix ">
				    <form id="search_from" class="form-horizontal" action="${pageContext.request.contextPath}/ada-domain/list.jhtm" method="get">
				    	<!--
						...
						<div class="row">
										...
										<div class="col-md-1 col-sm-12">
										<input type="text" class="form-control search-field input-small" name="search_LIKE_domain" value="${param.search_LIKE_domain}"  placeholder="网页链接地址"/>
										</div>
		    ...
		    <div class="col-md-2 col-sm-12 right">
	            <a class="buttons-excel buttons-html5 btn purple btn-outline opt-export" data-opt-key="/ada-domain/export"><span>导出表格</span></a>
	...
	<div class="portlet-body">
		<div class="row">
		    ...
		    <div class="col-md-6 col-sm-12">
		       <button type="button" class="btn green" onclick="gotoPage('${pageContext.request.contextPath}/ada-domain/create.jhtm')" data-opt-key="/ada-domain/create"><i class="fa fa-plus"></i>&nbsp;&nbsp;新增&nbsp;&nbsp;</button>
		    </div>
		    <!-- 左上角功能区 END -->
	            ...
	            <tbody>
	               <c:forEach var="item" items="${page.pageResults}" varStatus="number">
	                <tr>      
	                    ...
	                    <td>
	                    	<a class="btn btn-default btn-outline btn-sm opt-edit" data-id="${item.id}"  data-opt-key="/ada-domain/create"><span>&nbsp;&nbsp;编辑&nbsp;&nbsp;</span></a>
	                    	<a class="btn btn-default btn-outline btn-sm opt-delete" data-id="${item.id}"  data-opt-key="/ada-domain/delete"><span>&nbsp;&nbsp;删除&nbsp;&nbsp;</span></a>
	                    </td>
	                </tr>
	                </c:forEach>
	    ...
	    <div class="row">
	        ...
	        <c:if test="${not empty page.pageResults}">
	        	<div class="col-md-4 col-sm-12">
		            ...
		            <button class="btn btn-sm disabled opt-depend-select opt-batch-delete" data-opt-key="/ada-domain/delete">删除 </button>
		        </div>
			    <div class="row">
			        <!-- 底部分页 -->
			        <div class="col-md-4 col-sm-12">
...
<script type="text/javascript">
	...
	$(".opt-export").click(function() { 
		//refreshPage();
		var exportUrl = "${pageContext.request.contextPath}/ada-domain/export.do?"+$("#search_from").find("[value!='']").serialize();
    ...
    $(".opt-batch-delete").confirmation({
     ...
     var deleteItems = function(ids){
    	 jQuery.ajax({
      		url:"${pageContext.request.contextPath}/ada-domain/delete.do?id="+ids,
        ...
        <div class="tab-pane page-quick-sidebar-settings">
            <div class="page-quick-sidebar-settings-list">
                ...
                <div class="list-items">
					<form id="edit_form" action="${pageContext.request.contextPath}/ada-domain/update.do" class="form-horizontal" method="post">
			        	<input type="hidden" name="id">
		               	<div class="form-body">
			               	...
			               	<div class="form-group">
			               		<label class="col-md-4 control-label">网页链接地址<span class="required" > * </span></label>	
			               		<div class="col-md-8">
					                <input type="text" name="domain" class="form-control" required="required" maxlength="64">
								</div>
			               	</div>
			               	<div class="form-group">
			               		<label class="col-md-4 control-label">创建时间</label>	
			               		<div class="col-md-8">
									<input name="createTime" class="form-control form-control-inline datetimepick" type="text" data-date-format="yyyy-mm-dd hh:ii:ss" value="<fmt:formatDate value="${adaDomain.createTime}" pattern="yyyy-MM-dd HH:mm:ss"/>"  readonly="readonly">
								</div>
			               	</div>
		               	</div>  
			        </form> 
...
<script type="text/javascript">
    ...
    $('.opt-edit').click(function(){
    	 var id = $(this).attr("data-id");
    		 $.ajax({  
                 url : "${pageContext.request.contextPath}/ada-domain/get.do",
                 data : {"id" : id},
                 success : function(ret) {
                 		$("#edit_form").find("[name='id']").val(ret.entity.id);
                 		$("#edit_form").find("[name='siteId']").val(ret.entity.siteId);
                 		$("#edit_form").find("[name='domain']").val(ret.entity.domain);
    ...
    $(".opt-edit-delete").confirmation({
        ...
        onConfirm: function(){
        	...
        	jQuery.ajax({
          		url:"${pageContext.request.contextPath}/ada-domain/delete.do?id="+id,
          		success:function(ret){
          			if(ret.success){
          				$("body").toggleClass("page-quick-sidebar-open");
	           			toastr.success(ret.message);

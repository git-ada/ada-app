		...
		loadAjaxContent: function(e, a) {
			...
			App.startPageLoading({
				...
				success: function(e) {
					...
					a.size() > 0 && 0 === a.parents("li.open").size() && $(".page-sidebar-menu > li.open > a").click(), i.html(e), Layout.fixContentHeight(), App.initAjax()
				},
				error: function(e, a, o) {
					App.stopPageLoading(), i.html("<h4>加载内容失败，请刷新重试.</h4>");
					for (var n = 0; n < s.length; n++) t[n].call(e)
				}
			})
		},
		loadAjaxOnly: function(e) {
			var i = $(".page-content .page-content-body");
			App.startPageLoading({
				animate: !0
			}), $.ajax({
				...
				success: function(e) {
					...
					i.html(e), Layout.fixContentHeight(), App.initAjax()
				},
				error: function(e, a, o) {
					App.stopPageLoading(), i.html("<h4>加载内容失败，请刷新重试.</h4>");
					for (var n = 0; n < s.length; n++) t[n].call(e)

...
//		忘记密码第二步
		f = function() {
//			$(".forget-second-form").validate({
//				
//			}),	
			jQuery("#f-to-secod").click(function() {
				jQuery(".forget-form").hide(), jQuery(".forget-second-form").show()
			}), jQuery("#back-btn2").click(function() {
				jQuery(".forget-second-form").hide(), jQuery(".forget-form").show()
			})
			
		},
//		修改密码成功
		s = function() {
				jQuery("#f-to-finish").click(function() {
				jQuery(".forget-second-form").hide(), jQuery(".forget-change-succeed").show()
			})
		};
		d = function() {
				jQuery("#f-to-successd").click(function() {
				jQuery(".forget-change-succeed").hide(), jQuery(".login-form").show()
			})
		};

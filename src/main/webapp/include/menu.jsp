...
<li class="nav-item"><a href="${pageContext.request.contextPath}/ada-user/list.jhtm" class="ajaxify nav-link" ><i class="icon-graph"></i><span class="title">用户管理</span></a></li>

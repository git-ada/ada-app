...
<li class="nav-item"><a href="${pageContext.request.contextPath}/dashboard.jhtm?dataType=domain&firstTd=&top=&isRefresh=true" class="ajaxify nav-link" ><i class="icon-home"></i><span class="title">全站统计</span></a></li>

...
<li class="nav-item"><a href="${pageContext.request.contextPath}/ada-domain-stat/list.jhtm" class="ajaxify nav-link" ><i class="icon-bar-chart"></i><span class="title">域名统计</span></a></li>

...
<li class="nav-item"><a href="${pageContext.request.contextPath}/dashboard.jhtm?dataType=domain" class="ajaxify nav-link" ><i class="icon-home"></i><span class="title">实时数据</span></a></li>
<li class="nav-item"><a href="${pageContext.request.contextPath}/dashboard.jhtm?dataType=domainAd" class="ajaxify nav-link" ><i class="icon-bar-chart"></i><span class="title">广告入口统计</span></a></li>
<li class="nav-item"><a href="${pageContext.request.contextPath}/dashboard.jhtm?dataType=domainNotAd" class="ajaxify nav-link" ><i class="icon-bar-chart"></i><span class="title">非广告入口统计</span></a></li>

...
<c:if test="${user.userRole=='admin'}"><li class="nav-item"><a href="${pageContext.request.contextPath}/siteList.jhtm" class="ajaxify nav-link" ><i class="icon-bar-chart"></i><span class="title">站点列表</span></a></li></c:if> 
